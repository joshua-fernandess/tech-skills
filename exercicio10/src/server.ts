...
app.get("/users/:id", (req: Request<{ id: string }>, res: Response): Response => {
    const { id } = req.params;
...
app.put("/users/:id", (req: Request<{ id: string }>, res: Response): Response => {
    const { id } = req.params;
...
app.delete("/users/:id", (req: Request<{ id: string }>, res: Response): Response => {
    const { id } = req.params;
